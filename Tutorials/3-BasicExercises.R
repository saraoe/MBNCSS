...
plot_prior(priorRDM1,designRDM1,layout=c(2,6))
...
plot_prior(priorRDM2,designRDM2,layout=c(2,6))
...
plot_prior(priorLBA0,designLBA0,layout=c(2,5))
...
#    compared.
posterior_summary(sRDM0,map=TRUE)
posterior_summary(sLBA0,map=TRUE)
